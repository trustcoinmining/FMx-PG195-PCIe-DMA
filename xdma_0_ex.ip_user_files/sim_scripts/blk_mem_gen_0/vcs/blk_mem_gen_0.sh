...
#
# Generated by Vivado on Sat Mar 02 21:20:33 +0900 2019
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
